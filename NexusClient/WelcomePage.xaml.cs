...
public sealed partial class WelcomePage : Page
{
    ...
    private async void CheckIfExists()
    {
        ...
        {
            Debug.WriteLine(e);
            if (e is ArgumentNullException || e is RiotResponseException) ErrorTextBlock.Text = "L'invocateur recherché est invalide";
    ...
    {
        MenuFlyoutItem buttonClicked = (MenuFlyoutItem)e.OriginalSource;
